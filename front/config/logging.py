...
for log_dir in [FRONTEND_LOGS_DIR,
...
def setup_frontend_logging():
    ...
    logger.info("Frontend logging system initialized", extra={
...
def log_user_action(action: str, page: str = None, success: bool = True, 
                   resource: str = None, details: Dict = None, **kwargs):
    """Log user actions"""
...
def log_permission_check(permission: str, resource: str = None, granted: bool = True, 
...
def log_ui_interaction(component: str, action: str, page: str = None, 
                      user_input: Any = None, **kwargs):
    """Log UI interactions"""
...
def log_frontend_error(error: Exception, context: str = None, page: str = None, 
    ...
    message = f"Frontend error in {context}: {error}" if context else f"Frontend error: {error}"
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                extra["error"] = str(e)
                logger.error(f"Function failed: {func_name}", extra=extra, exc_info=True)
                raise
