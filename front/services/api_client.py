...
class APIClient:
    ...
    def _make_request(self, method: str, endpoint: str, data: Dict = None, 
                     token: Optional[str] = None, params: Dict = None) -> Dict[str, Any]:
    ...
    def create_role(self, name: str, description: str = None, is_active: bool = True) -> Dict[str, Any]:
        """Create new role"""
        data = {
            "name": name,
    ...
    def assign_permission_to_role(self, role_id: int, permission_id: int) -> Dict[str, Any]:
        """Assign permission to role"""
        return self._make_request("POST", f"/admin/roles/{role_id}/permissions/{permission_id}")
    
    def remove_permission_from_role(self, role_id: int, permission_id: int) -> Dict[str, Any]:
        """Remove permission from role"""
        return self._make_request("DELETE", f"/admin/roles/{role_id}/permissions/{permission_id}")
