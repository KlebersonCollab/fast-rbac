...
class PermissionService:
    ...
    async def _get_user_permissions_from_db(
    ...
    async def _get_user_roles_from_db(
        self, user_id: int, db: Session = None
    ) -> List[str]:
    ...
    async def has_permission(
        self, user_id: int, permission: str, db: Session = None
    ) -> bool:
    ...
    async def has_any_permission(
        self, user_id: int, permissions: List[str], db: Session = None
    ) -> bool:
