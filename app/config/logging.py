...
for log_dir in [
    BACKEND_LOGS_DIR,
    SYSTEM_LOGS_DIR,
    BACKEND_LOGS_DIR / "auth",
    BACKEND_LOGS_DIR / "rbac",
    BACKEND_LOGS_DIR / "api",
    BACKEND_LOGS_DIR / "errors",
    SYSTEM_LOGS_DIR / "startup",
    SYSTEM_LOGS_DIR / "health",
]:
...
def get_logging_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "loggers": {
            ...
            "fastapi": {"level": "INFO", "handlers": ["app_file"], "propagate": False},
            "sqlalchemy.engine": {
                "level": "WARNING",
                "handlers": ["app_file"],
                "propagate": False,
